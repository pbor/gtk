...
/**
 * gtk_css_gadget_margin_allocation_contains_point:
 ...
 *   margin allocation of the gadget. The (X, Y) are relative to the gadget
 *   origin.
 *
 * Returns: %TRUE if the point at (X, Y) is contained within the margin
 *   allocation of the @gadget.
 */
gboolean
gtk_css_gadget_margin_allocation_contains_point (GtkCssGadget *gadget,
                                                 int           x,
                                                 int           y)
{
...
/**
 * gtk_css_gadget_border_allocation_contains_point:
 * @gadget: the #GtkCssGadget being tested
 * @x: X coordinate of the testing point
 * @y: Y coordinate of the testing point
 *
 * Checks whether the point at the provided coordinates is contained within the
 *   border allocation of the gadget. The (X, Y) are relative to the gadget
 *   origin.
 *
 ...
 */
gboolean
gtk_css_gadget_border_allocation_contains_point (GtkCssGadget *gadget,
                                                 int           x,
                                                 int           y)
{
...
/**
 * gtk_css_gadget_content_allocation_contains_point:
 * @gadget: the #GtkCssGadget being tested
 * @x: X coordinate of the testing point
 * @y: Y coordinate of the testing point
 *
 * Checks whether the point at the provided coordinates is contained within the
 *   content allocation of the gadget. The (X, Y) are relative to the gadget
 *   origin.
 *
 ...
 */
gboolean
gtk_css_gadget_content_allocation_contains_point (GtkCssGadget *gadget,
                                                 int           x,
                                                 int           y)
{
